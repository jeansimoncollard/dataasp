    ...
    <asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="row">
            <div class="col-md-6 full-height">
                <div class="row">
                    <h3 class="element-top-10 element-bottom-10">Fun Facts</h3>
                    ...
                    <ul>
                        <p class="element-top-10 element-bottom-10"><strong>Here are the most well known consequences:</strong>
                        </p>
                    ...
                    <p>A tree can absorb as much as 0.45kg of CO2 per year, 
                        which means it will take over 250 trees to offset the Average human each year</p>
                </div>
            </div>
            <div class="col-md-6 full-height">
                <div class="row">
